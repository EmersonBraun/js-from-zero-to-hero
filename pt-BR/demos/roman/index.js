...
function printToRoman() {
    const value = document.getElementById('romanToDecimal').value
    if(isNaN(+value)) {
        return
    } else {
        document.getElementById('decimal').innerHTML = toRoman(value)
    }
}

function printFromRoman() {
    const value = document.getElementById('decimalToRoman').value
    if(!isNaN(+value)) {
        document.getElementById('roman').innerHTML = ''
    } else {
        document.getElementById('roman').innerHTML = fromRoman(value)
    }
}
